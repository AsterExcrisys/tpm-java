...
./build/install/attestation-tester/bin/attestation-tester --device --type tap-uni --type tap --type tap-ssl --type tap-dh --type mscp --type mscp-ext --type mscp-org --n 100 > results-hw.log
