...
public interface TpmEngine {
	 ...
	 */
	boolean verifyQuote(byte[] quote, byte[] qualifyingData, byte[] quotingKeyPub, Map<Integer, String> pcrValues)
	 ...
	 */
	default String prettyPrintPublicKey(byte[] publicKey) throws TpmEngineException {
		return SecurityHelper.bytesToHex(publicKey);
	}
	 ...
	 */
	default String prettyPrintQuote(byte[] quote) throws TpmEngineException {
		return SecurityHelper.bytesToHex(quote);
	}
	 ...
	 */
	default String prettyPrintCertificate(byte[] cert) throws TpmEngineException {
		return SecurityHelper.bytesToHex(cert);
	}
