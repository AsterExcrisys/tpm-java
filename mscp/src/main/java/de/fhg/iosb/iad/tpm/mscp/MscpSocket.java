...
import de.fhg.iosb.iad.tpm.mscp.handshake.ClientHandshaker;
import de.fhg.iosb.iad.tpm.mscp.handshake.Handshaker;
import de.fhg.iosb.iad.tpm.mscp.handshake.ServerHandshaker;

public class MscpSocket extends Socket {
	...
	protected void performHandshake(boolean server) throws IOException {
		this.handshaker = server ? new ServerHandshaker(super.getInputStream(), super.getOutputStream(), config)
				: new ClientHandshaker(super.getInputStream(), super.getOutputStream(), config);
