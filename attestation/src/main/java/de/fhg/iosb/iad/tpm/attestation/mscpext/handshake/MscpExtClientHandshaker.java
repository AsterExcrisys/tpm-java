...
public class MscpExtClientHandshaker extends MscpExtHandshaker {

	private static final Logger LOG = LoggerFactory.getLogger(MscpExtClientHandshaker.class);

	public MscpExtClientHandshaker(InputStream inputStream, OutputStream outputStream, TapDhConfiguration config) {
