...
public class TapDhServerHandshaker extends TapDhHandshaker {

	private static final Logger LOG = LoggerFactory.getLogger(TapDhServerHandshaker.class);

	public TapDhServerHandshaker(InputStream inputStream, OutputStream outputStream, TapDhConfiguration config) {
