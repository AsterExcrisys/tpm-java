...
public class TapSslClientHandshaker extends TapSslHandshaker {

	private static final Logger LOG = LoggerFactory.getLogger(TapSslClientHandshaker.class);

	public TapSslClientHandshaker(InputStream inputStream, OutputStream outputStream, TapSslConfiguration config) {
