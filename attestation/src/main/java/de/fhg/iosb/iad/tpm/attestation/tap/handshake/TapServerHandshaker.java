...
public class TapServerHandshaker extends TapHandshaker {

	private static final Logger LOG = LoggerFactory.getLogger(TapServerHandshaker.class);

	public TapServerHandshaker(InputStream inputStream, OutputStream outputStream, TapConfiguration config) {
